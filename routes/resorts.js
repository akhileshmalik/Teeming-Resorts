...
var { isLoggedIn, checkUserResort, checkUserComment, isAdmin, isSafe } = middleware; // destructuring assignment
...
router.post("/", isLoggedIn, isSafe, function(req, res){
  ...
  //   var location = data.results[0].formatted_address;
    var newResort = {name: name, image: image, description: desc, cost: cost, address: address, author:author};
